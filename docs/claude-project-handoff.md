...
11. **No live-backend guarantee comes from the unit suite.** The 114 tests use fakes by design; configuration discovery and a live demo proof must be run separately.
